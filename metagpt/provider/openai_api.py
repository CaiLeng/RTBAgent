...
@register_provider([LLMType.OPENAI, LLMType.FIREWORKS, LLMType.OPEN_LLM, LLMType.MOONSHOT, LLMType.MISTRAL, LLMType.YI, LLMType.BAICHUAN, LLMType.LLAMA, LLMType.QWEN])
class OpenAILLM(BaseLLM):
    ...
    async def _achat_completion_stream(self, messages: list[dict], timeout=3) -> str:
        ...
        async for chunk in response:
            ...
            if finish_reason:
                if hasattr(chunk, "usage") and chunk.usage is not None: # 修改2024.7.31
